defmodule UndionlineWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {UndionlineWeb.LayoutView, :root}
  ...
  pipeline :api_authenticated do
    plug UndionlineWeb.AuthAccessPipeline
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: UndionlineWeb.Telemetry, ecto_repos: [Undionline.Repo]
    end
  end
